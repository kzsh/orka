...
Running `orka scratchpad` without a name lists existing scratchpads in an interactive fuzzy selector: type to narrow, arrows or Ctrl-N/Ctrl-P to move, Enter to select, Esc to abort.
